...
import img1 from "../../assets/Untitled-1-01.png";
import img2 from "../../assets/Untitled-2-01.png";
import img3 from "../../assets/Untitled-3-01.png";
import img4 from "../../assets/Untitled-4-01.png";
import img5 from "../../assets/Untitled-5-01.png";
import img6 from "../../assets/Untitled-3-03.png";
import img7 from "../../assets/Untitled-6-01.png";
        ...
        <div className="carousel-container">
            <aside className="carousel">
                <div className="carousel__wrapper">
                    ...
                    <div className="item" id="slide-1"><img src={img2} alt="Fireflies Logo" width="418" height="418" /></div>
                    <div className="item" id="slide-2"><img src={img6} alt="The Pluto Store Logo" width="418" height="418" /></div>
                    <div className="item" id="slide-3"><img src={img3} alt="Sandhya Logo" width="418" height="418" /></div>
                    <div className="item" id="slide-4"><img src={img4} alt="Shopoholicgene Logo" width="418" height="418" /></div>
                    <div className="item" id="slide-5"><img src={img7} alt="Click & Buy Logo" width="418" height="418" /></div>
                    <div className="item" id="slide-6"><img src={img5} alt="Catering Bros Logo" width="418" height="418" /></div>                
                </div>
            </aside>
            <article className="instagram">
                <header className="instagram__header">
                    <figure><img src={HeaderLogo} alt="Ansaf Logo" width="50" height="50" />
                        <figcaption>
                            <h4 style={{color:"#444444"}}>Ansaf Akhtar</h4>
                        </figcaption>
                    </figure>
                </header>
